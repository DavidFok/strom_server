            ...
            if (!result) {
                ...
                .then((res) => {
                    ...
                    if (res[0] === "confirm") {
                        ...
                        .then((createResult) => {
                            let res = createResult[0]
                            
                            console.log("============= this is createResult============", "\n", createResult);

                            dataHelpers.chargeEndTimer(res.charge_end, res.spot_id, dataHelpers.makeSpotAvailable);

                            // ADD ENDTIME TO THE OUTBOUND MESSAGE
                            outMsgVcle.data.endTime = res.charge_end;
